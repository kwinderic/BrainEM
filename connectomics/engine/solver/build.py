...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module, lr_factor_func=None) -> torch.optim.Optimizer:
    """
    ...
    for module_name, module in model.named_modules():
        for key, value in module.named_parameters(recurse=False):
            ...
            if lr_factor_func is not None:
                lr *= lr_factor_func(f"{module_name}.{module_param_name}")
