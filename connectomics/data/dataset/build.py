...
def seed_worker(worker_id):
    ...
    worker_seed = (worker_id + torch.initial_seed()) % 2**32      # use different seed for different worker
    print(f"worker: {worker_id} {worker_seed}")
...
def build_dataloader(cfg, augmentor=None, mode='train', dataset=None, rank=None,
    ...
    if mode == 'train':
        ...
        batch_size = cfg.SOLVER.SAMPLES_PER_BATCH * cfg.SYSTEM.NUM_GPUS
    else:
