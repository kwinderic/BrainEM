...
class InstDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, pred_affinity, init_masks=None):
        ...
        out = self.seg_head(x, mask_features, queries=obj_feat)
        ...
        return pred_masks_list, [None], recorded_init_masks    # pred_kernel_list=[]



class AffinityKNetMaskFormer(UNet3D, E2EMixin):
    """
